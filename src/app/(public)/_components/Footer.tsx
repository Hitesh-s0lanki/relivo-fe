      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-5">
          ...
          <div className="col-span-2">
            <Link href="/" className="mb-5 flex items-center gap-2.5 cursor-pointer">
            ...
            <div className="mt-6 flex items-center gap-2">
              <a
                ...
                aria-label="GitHub"
                className="flex items-center justify-center size-8 rounded-md border border-gray-200 text-gray-400 hover:border-gray-300 hover:text-gray-600 transition-colors cursor-pointer"
              >
